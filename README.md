...
## Тестування
Проект включає понад 82 модульних тестів, що покривають:
...
- Демонструє взаємозв'язки між компонентами системи
- Показує ієрархію класів та їх відносини
- Відображає використані патерни проектування

### Діаграма використання
![Use Case Diagram](docs/use_case_diagram.png)
- Показує взаємодію користувачів з системою
- Відображає основні функції системи
- Демонструє ролі користувачів
...
- ✓ Застосування патернів (4/4)
- ✓ Застосування принципів проектування (4/4)
- ✓ Використання UML діаграм (3/3)
- ✓ Розуміння закономірностей (2/2)
- ✓ Якість коду (2/2)
- ✓ Тестування (3/3)
- ✓ Документація (2/2)